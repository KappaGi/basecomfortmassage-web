        ...
        <div class="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[110rem] mx-auto">
            ...
            <div class="flex md:hidden justify-between items-center relative">
                ...
                <div class="flex items-center gap-3 ml-auto">
                    <a href="../en/${activePage === 'home' ? 'index' : activePage}.html" class="language-switcher flex items-center text-base-tan hover:opacity-70 transition-opacity no-underline">
